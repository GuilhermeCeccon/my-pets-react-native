    ...
    return (
        <ScrollView>
            <View style={styles.architecture}>
                ...
                <Text style={styles.architectureInfo}>store.js: Armazena informações do usuário.</Text>
                ...
                <Text style={styles.architectureInfo}>petsAction.js: Responsável por buscar a lista de informações do banco de dados.</Text>
                ...
                <Text style={styles.architectureInfo}>petReducer.js: Responsável por salvar um novo pet no banco e mandar para a store.</Text>
                <Text style={styles.architectureInfo}>petsReducer.js: Responsável por retornar as informações dos pets contidas na store.</Text>
                ...
                <Text style={styles.architectureInfo}>Login.js: Responsável por logar o usuário no app e redirecionar o usuário para criar uma nova conta.</Text>
                <Text style={styles.architectureInfo}>Maps.js: Mostra a localização do pet e a localização atual do usuário.</Text>
                <Text style={styles.architectureInfo}>Menu.js: Lista as opções de funcionalidaes disponíveis para o usuário.</Text>
                ...
                <Text style={styles.architectureInfo}>Sobre.js: Contém o nome do app e informações do desenvolvedor.</Text>
